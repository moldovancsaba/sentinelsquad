...
CHATDEV_PATH="${CHATDEV_PATH:-/Users/moldovancsaba/Projects/sentinelsquad/external/ChatDev}"
SENTINELSQUAD_PATH="${SENTINELSQUAD_PATH:-/Users/moldovancsaba/Projects/sentinelsquad/apps/sentinelsquad}"
