...
## Prerequisites
- SentinelSquad running on `http://localhost:3007`
- Ollama running on `http://127.0.0.1:11434`
- ChatDev cloned in `external/ChatDev` and `.venv` prepared
- MCP settings installed via `apps/sentinelsquad/scripts/nexus/setup_mcp.sh`
...
## Artifact
Result is saved to:
- `.sentinelsquad/nexus/cell-last-run.json`
