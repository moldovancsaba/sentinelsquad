...
export default async function SettingsPage() {
  ...
  return (
    <Shell
      title="Settings"
      subtitle="Global SentinelSquad settings. Agent and project settings are edited in their own pages."
    >
      <div className="space-y-6">
        ...
        <div className="rounded-2xl border border-white/12 bg-white/5 p-5">
          ...
          <div className="mt-1 text-xs text-white/60">
            Settings are stored locally at `.sentinelsquad/settings.json`. Keep secrets in `.env` or `.env.local`.
          </div>
        </div>
      </div>
    </Shell>
