...
- [SOVEREIGN_PROJECT_BOARD_SSOT.md](SOVEREIGN_PROJECT_BOARD_SSOT.md) — **SSOT for delivery + board**: LLDs (#437–#446), extended (#432, #433, #436, **#448–#450** Mac mini deploy), hybrid PO [#447](https://github.com/moldovancsaba/mvp-factory-control/issues/447), **§3.2** how to deliver, **§3.3** reconciling drift
